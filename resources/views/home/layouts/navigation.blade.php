...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="{{ url('/') }}">Toko Jussy</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form action="{{ route('logout') }}" method="post" class="d-flex gap-2">
                    @csrf
                    <a href="{{ url('/shop/chart') }}" class="btn btn-outline-dark" type="submit">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="LogOut"
                                        onclick="event.preventDefault();
                                                    this.closest('form').submit();"><i class="bi bi-box-arrow-right"></i> Logout
                                        </a></li>
                                </ul>
                            </li>
                        @else
